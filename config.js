...
config.http_request_timeout_seconds = process.env.HTTP_REQUEST_TIMEOUT_SECONDS || 5000;
...
config.refresh_pipeline_in_seconds = process.env.REFRESH_PIPELINE_SECONDS || 10;
